      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <Reveal width="100%">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl leading-tight">
              Entre em contato{' '}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-accent-400 to-accent-500">
                conosco
              </span>
            </h2>
        ...
        <Reveal delay={150} width="100%">
          ...
          >
            {mapLoaded ? (
              ...
              <div className="flex items-center justify-center w-full h-95 bg-brand-800/60 rounded-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <Reveal delay={200} width="100%">
            ...
            >
              <span className="absolute top-0 left-5 right-5 h-px bg-linear-to-r from-transparent via-accent-500/50 to-transparent" />
              ...
              <div className="absolute -bottom-10 -right-10 w-40 h-40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(207,46,120,0.12) 0%, transparent 70%)' }} />
            </a>
          </Reveal>
