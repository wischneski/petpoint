    ...
    <section id="hero" className="relative min-h-[85vh] flex items-start justify-center overflow-hidden bg-brand-900 pt-24 md:pt-28">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-8 md:pt-12">
        <div className="max-w-4xl">
          ...
          {/* Eyebrow — imediato, sem animação */}
          <div className="flex items-center gap-3 mb-8">
            <span className="h-px w-12 bg-accent-500" />
            <span className="text-xs font-bold tracking-[0.3em] text-accent-400 uppercase">
              Morro da Fumaça, SC · +14 anos
            </span>
          </div>

          {/* H1 — imediato e visível: é o elemento LCP */}
          ...
          {/* Conteúdo abaixo do H1 — animação CSS (sem JS, sem delay de hidratação) */}
          <p className="hero-sub text-lg md:text-xl text-gray-300 mb-12 max-w-xl leading-relaxed font-light border-l-2 border-brand-600 pl-6">
      ...
      <div className="absolute bottom-10 left-6 hidden md:flex items-center gap-4 text-white/30">
        ...
        <div className="h-16 w-px bg-linear-to-b from-accent-500 to-transparent" />
      </div>
    </section>
  );
}
