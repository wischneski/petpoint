...
const Card: FC<CardProps> = ({ image, alt, sub, title, large, delay = 0 }) => (
  <a
    ...
    style={{ minHeight: large ? 340 : 180, animation: `fadeSlideUp 0.6s ease-out ${delay}ms both` }}
  >
    <img
      src={image}
      alt={alt}
    ...
    />
    <div className="absolute inset-0 bg-linear-to-t from-brand-900/90 via-brand-900/25 to-transparent group-hover:from-brand-900/70 transition-opacity duration-500" />
    ...
    <section id="petshop" className="py-32 bg-brand-900 relative overflow-hidden below-fold">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <Reveal width="100%">
            <span className="text-accent-400 font-bold tracking-widest uppercase text-xs mb-4 block">PetShop Premium</span>
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-tight">
              Tudo que seu pet <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-400 to-white">precisa aqui.</span>
            </h2>
          </Reveal>
          <Reveal delay={200}>
            <a
        ...
        <Reveal delay={100} width="100%">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" style={{ gridTemplateRows: '260px 260px' }}>
            <div className="col-span-2 row-span-2">
              <Card image="/images/petshop/nutricao.webp" alt="Nutrição Premium" sub="Rações & Suplementos" title="Nutrição Premium" large delay={0} />
            </div>
            <div><Card image="/images/petshop/caes.webp"      alt="Cães"       sub="Linha completa"         title="Cães"       delay={80}  /></div>
            <div><Card image="/images/petshop/gatos.webp"     alt="Gatos"      sub="Linha completa"         title="Gatos"      delay={160} /></div>
            <div><Card image="/images/petshop/acessorios.webp" alt="Acessórios" sub="Brinquedos & Conforto" title="Acessórios" delay={240} /></div>
            <div><Card image="/images/petshop/conforto.webp"  alt="Conforto"   sub="Bem Estar Animal"       title="Conforto"   delay={320} /></div>
          </div>
        </Reveal>

        <Reveal delay={350} width="100%">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4" style={{ gridTemplateRows: '200px' }}>
            <div><Card image="/images/petshop/higiene.webp"  alt="Higiene"   sub="Banho & Cuidados"           title="Higiene"   delay={400} /></div>
            <div><Card image="/images/petshop/pequenos.webp" alt="Exóticos"  sub="Coelhos, hamsters e mais"   title="Exóticos"  delay={480} /></div>
            <div><Card image="/images/petshop/farmacia.webp" alt="Farmácia"  sub="Medicamentos & Vitaminas"   title="Farmácia"  delay={560} /></div>
          </div>
        </Reveal>

        <Reveal delay={600} width="100%">
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-white/6">
