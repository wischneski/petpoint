        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6">
              {[
                { icon: Stethoscope, title: 'Diagnóstico Preciso',  desc: 'Tecnologia a favor da saúde.',                                      color: 'text-brand-600', bg: 'bg-brand-100' },
                { icon: Heart,       title: 'Estética Humanizada',   desc: 'Respeito ao temperamento de cada animal.',                           color: 'text-accent-500', bg: 'bg-pink-50' },
                { icon: ShieldCheck, title: 'PetShop Completo',      desc: 'Apenas produtos que nós usaríamos nos nossos próprios pets.',         color: 'text-brand-600', bg: 'bg-brand-100' },
              ].map((item, idx) => (
          ...
          <div className="order-1 lg:order-2 relative">
            <Reveal delay={200}>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-brand-900/10 aspect-4/5">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-brand-900/80 to-transparent p-8">
